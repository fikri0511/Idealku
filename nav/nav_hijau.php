...
.menu {
 ...
 <!-- Navbar -->
     ...
     <li id="login" >
      ...
      <li id="../daftar" style="float : right; margin-top: 13px;">
      
        <a style="float: left"  href="../login/logout.php" role="button" 
  ...
  <ul class="navbar-nav ">
  	<div>
  <a class="navbar-brand" href="../index.php"><img src="../atribut/ideal.png"></a>
    <li class="nav-item">
    ...
    <div>
  <a class="navbar-brand" href="../bayi.php"><img src="../atribut/bayi.png"></a>
    <li class="nav-item">

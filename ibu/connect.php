...
function register($infologin){
	...
	$umur = htmlspecialchars(stripcslashes($infologin["umur"])); 
	$kelamin = htmlspecialchars(stripcslashes($infologin["kelamin"])); 
	...
	$query = mysqli_query($conn, "INSERT INTO users (username, password, email,no_hp,nama,umur,kelamin) VALUES ('$username','$password', '$email','$no_hp','$nama','$umur','$kelamin')");
